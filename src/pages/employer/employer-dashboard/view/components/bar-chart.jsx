...
const bar = {
    ...
    yAxis: {
      type: 'category',
      data: ['Finance', 'Consulting', 'Midical',  'Accounting', 'Engineering', 'Information Technology']
    },
    series: [
      {
        name: '2011',
  ...
  return (
    ...
    <Flex gap="1" mt="9" mx="8" justify="center">
        ...
        <Box width="800px" height="550px" >
                <ReactECharts option={bar3} notMerge={true} lazyUpdate={true} style={{ height: "100%", width: "100%" }} />
        </Box>
