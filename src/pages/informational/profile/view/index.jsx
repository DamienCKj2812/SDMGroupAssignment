...
const Profile = () => {
    ...
    <Box className="panel">
        <Box className="inside-panel">
            <Flex justify="space-between"> {/* Use space-between to separate items */}
                <Flex direction="column" className="words" >
                    <Box className="header">
                        <h1>Be seen with a Applicant Finder profile</h1>      
                    </Box>
                    <Box className="text1">An Applicant Finder provides you with a personalised search experience and more relevant job recommendations - so you can find your job faster.</Box>
          ...
          <Box className="panel2">
                <h1 className="header1">The career profile to land your next great job</h1>
                    ...
                    <p>Recruiters and employers can view your profile and contact you to discuss new opportunities – even when you’re not looking.</p>
                        </Box>
                    ...
                    <a href=""><p>Learn about profile visibility</p></a>
                        </Box>
                        <Box>
                        <Box className="img-size">
                    ...
                    <Box className="hiring-container">
                        ...
                        <Button mt="5" ml="6">Employer site</Button>  
                        </Flex>
