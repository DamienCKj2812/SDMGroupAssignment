    ...
    return (
        <Box id="product-view">
            ...
            <TabNav.Root size="2" className="tabNav">
                <TabNav.Link href="#" active={activeTab === "standard"} onClick={() => setActiveTab("standard")}>
                    Standard Ad Budget
                </TabNav.Link>

                <TabNav.Link href="#" active={activeTab === "premium"} onClick={() => setActiveTab("premium")}>
                    Premium Ad Budget
                </TabNav.Link>
            </TabNav.Root>
                    ...
                    <Box className="standard-content">
                        ...
                        <Flex>
                            <Box className="box-container">
                                ...
                                <p>
                                    <Badge color="orange">6% off now</Badge>
                                </p>

                                <Flex className="check-word">
                                    <IoCheckmark style={{ marginTop: "20px", marginRight: "10px" }} size={30} />
                                    <p>Post premium and branded ad</p>
                                </Flex>

                                <Flex className="check-word">
                                    <IoCheckmark style={{ marginTop: "20px", marginRight: "10px" }} size={30} />
                                    <p>Discount applies for 12 months</p>
                                </Flex>
                            </Box>
                            ...
                            <Box className="box-container">
                                ...
                                <p>
                                    <Badge color="orange">10% off now</Badge>
                                </p>

                                <Flex className="check-word">
                                    <IoCheckmark style={{ marginTop: "20px", marginRight: "10px" }} size={30} />
                                    <p>Post Branded and Premium ads</p>
                                </Flex>
                    ...
                    <Box className="premium-content">
                        ...
                        <Flex>
                            <Box className="box-container">
                                ...
                                <Flex className="check-word">
                                    <IoCheckmark style={{ marginTop: "20px", marginRight: "10px" }} size={30} />
                                    <p>Highlighted job search results</p>
                                </Flex>
                            ...
                            <Box className="box-container">
                                ...
                                <p>
                                    <Badge color="orange">20% off now</Badge>
                                </p>
                ...
                <Accordion.Root className="AccordionRoot" type="single" defaultValue="item-1" collapsible>
                        ...
                        <Accordion.Header>
                            <Accordion.Trigger className="Accordion-question">
                                <Flex>
                                    ...
                                    <IoChevronDownOutline size={30} style={{ marginLeft: "20px", marginTop: "6px" }} />
                                </Flex>
                            </Accordion.Trigger>
                        </Accordion.Header>
                        <Accordion.Content>
                            Our Ad Budget allows you to prepay for a discounted rate on job ads. This budget can be used for both Standard and Premium
                            job postings.
                        </Accordion.Content>
                    </Accordion.Item>
                    ...
                    <Accordion.Item className="AccordionItem" value="item-2">
                        <Accordion.Header>
                            <Accordion.Trigger className="Accordion-question">
                                <Flex>
                                    Standard and Premium Ad Budget difference?
                                    <IoChevronDownOutline size={30} style={{ marginLeft: "20px", marginTop: "6px" }} />
                                </Flex>
                            </Accordion.Trigger>
                        </Accordion.Header>
                        <Accordion.Content>
                            Standard Ad Budget gives you access to basic features, while Premium includes additional features such as highlighted job
                            listings.
                        </Accordion.Content>
                    </Accordion.Item>
                    <hr className="line"></hr>
                    <Accordion.Item className="AccordionItem" value="item-3">
                        <Accordion.Header>
                            <Accordion.Trigger className="Accordion-question">
                                <Flex>
                                    Can I change my Ad Budget plan later?
                                    <IoChevronDownOutline size={30} style={{ marginLeft: "20px", marginTop: "6px" }} />
                                </Flex>
                            </Accordion.Trigger>
                        </Accordion.Header>
                    ...
                    <Accordion.Item className="AccordionItem" value="item-4">
                        <Accordion.Header>
                            <Accordion.Trigger className="Accordion-question">
                                <Flex>
                                    Do unused Ad Budget funds expire?
                                    <IoChevronDownOutline size={30} style={{ marginLeft: "20px", marginTop: "6px" }} />
                                </Flex>
                            </Accordion.Trigger>
                        </Accordion.Header>
                    ...
                    <Accordion.Item className="AccordionItem" value="item-5">
                        <Accordion.Header>
                            <Accordion.Trigger className="Accordion-question">
                                <Flex>
                                    Are there any discounts for long-term ad plans?
                                    <IoChevronDownOutline size={30} style={{ marginLeft: "20px", marginTop: "6px" }} />
                                </Flex>
                            </Accordion.Trigger>
                        </Accordion.Header>
                        <Accordion.Content>Yes, we offer discounts for purchasing Ad Budget plans for 6 months or more upfront.</Accordion.Content>
                    </Accordion.Item>
                    <hr className="line"></hr>
                </Accordion.Root>
            </Box>
