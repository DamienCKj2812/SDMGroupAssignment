...
const EmployerJobs = ({ companyDetail, jobs }: { companyDetail: ICompany; jobs: IJob[] }) => {
    ...
    return (
        <Flex id="employer-jobs" direction="column" gap="4">
            <Heading as="h1" m="0">
            ...
            {filteredJobs.length > 0 ? (
                <Grid columns="2" gap="4">
                    {filteredJobs.map((j) => {
                        return (
                            <Flex direction="column" gap="3" className="job-card" onClick={() => navigate(`../employer-ads/${j.jobId}`)}>
